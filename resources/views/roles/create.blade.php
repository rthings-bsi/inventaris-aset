...
<div class="mb-8 flex items-center gap-4">
    ...
    <div>
        <h1 class="text-2xl font-black text-gray-800 tracking-tight">Tambah <span class="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600">Role Baru</span></h1>
        <p class="text-sm font-bold text-gray-500 mt-0.5">Definisikan peran baru untuk pengguna sistem.</p>
    </div>
</div>
